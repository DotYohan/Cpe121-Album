...
public class Inventory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(SelectNew, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 100, -1, -1));
        ...
        getContentPane().add(jToggleButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 130, -1, -1));
        ...
        getContentPane().add(jToggleButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 510, 70, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, 420, 260));
        getContentPane().add(InputField, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 450, 380, -1));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel2.setText("Options:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 480, 60, 20));

        buts.add(findname);
        findname.setText("Name");
        getContentPane().add(findname, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 520, -1, -1));

        buts.add(findprice);
        findprice.setText("Price");
        getContentPane().add(findprice, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 490, -1, -1));

        buts.add(findquant);
        findquant.setText("Quantity");
        getContentPane().add(findquant, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 520, -1, -1));

        buts.add(Code);
        Code.setText("Code");
        getContentPane().add(Code, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 490, -1, -1));
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
       updateForm open = new updateForm();
       open.setVisible(true);
       this.dispose();
